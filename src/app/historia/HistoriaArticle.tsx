    ...
    <>
      ...
      <main className="flex-1 px-4 py-10 max-w-2xl mx-auto w-full">
        <article className="bg-surface rounded-2xl shadow-sm border border-ink/10 p-6 sm:p-8 text-sm leading-relaxed text-ink">
          ...
          <div className="my-8 bg-page rounded-2xl border border-secondary p-6 flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            <ArrowRight className="w-6 h-6 text-primary shrink-0 rotate-90 sm:rotate-0" />
            <div className="flex flex-col items-center gap-2">
              <DecorativeQr size={140} seed={3} />
              <span className="text-xs font-bold text-ink/70">{c.qrCaption}</span>
            </div>
          </div>
